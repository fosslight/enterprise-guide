...
3. [`Pre-review > Open Source, License`](https://fosslight.org/hub-guide/tips/1_common/2_pre_review/)를 수행합니다.
4. `New Open Source, New Version`의 빨간색 Warning message가 남아 있는 경우, Comment를 남겨 LG 측에 리뷰를 요청합니다.
